    ...
    public static partial class Texts
    {
        ...
        public static class Forms
        {
            public static class Membership
            {
                ...
                {
                    public static LocalText EmailSubject = "Reset Your CaveSerene Password";
                ...
                {
                    public static LocalText FormTitle = "Welcome to CAVE-SERENE";
                ...
                public static class SignUp
                {
                    ...
                    public static LocalText FormTitle = "Sign up for CaveSerene";
        ...
        public static class Navigation
        {
            ...
            public static LocalText SiteTitle = "CaveSerene";
        }
