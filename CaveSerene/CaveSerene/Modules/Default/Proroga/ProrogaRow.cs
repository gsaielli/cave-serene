...
namespace CaveSerene.Default.Entities
{
    ...
    public sealed class ProrogaRow : Row, IIdRow, INameRow
    {
        ...
        [DisplayName("Protocollo"), Size(100), QuickSearch]
        ...
        [DisplayName("Nuova Data Sistemazione"), NotNull]
        public DateTime? NuovaDataSistemazione
        {
            get { return Fields.NuovaDataSistemazione[this]; }
            set { Fields.NuovaDataSistemazione[this] = value; }
        }
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public DateTimeField NuovaDataSistemazione;
