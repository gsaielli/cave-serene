...
namespace CaveSerene.Default.Entities
{
    ...
    [ConnectionKey("Default"), Module("Default"), TableName("[dbo].[Comune]")]
    [DisplayName("Comune"), InstanceName("Comune")]
    [ReadPermission("Administration:General")]
    [ModifyPermission("Administration:General")]
    [LookupScript("Default.Comune")]
    public sealed class ComuneRow : Row, IIdRow, INameRow
    {
        [DisplayName("Id"), Column("ID"), Size(6), PrimaryKey, QuickSearch]
        public String Id
        {
