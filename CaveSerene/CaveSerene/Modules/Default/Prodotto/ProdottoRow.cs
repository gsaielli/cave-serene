...
namespace CaveSerene.Default.Entities
{
    ...
    public sealed class ProdottoRow : Row, IIdRow, INameRow
    {
        ...
        [DisplayName("Descrizione"), Expression("jIdMateriale.[Descrizione]"), MinSelectLevel(SelectLevel.List)]
        ...
        {
            get { return Fields.IdMaterialeDescrizione; }
        }
