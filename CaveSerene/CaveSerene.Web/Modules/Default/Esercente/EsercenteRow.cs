...
namespace CaveSerene.Default.Entities
{
    ...
    public sealed class EsercenteRow : Row<EsercenteRow.RowFields>, IIdRow, INameRow
    {
        ...
        [DisplayName("Ragione Sociale"), Size(50), NotNull, QuickSearch, NameProperty]
        ...
        public EsercenteRow(RowFields f)
            : base(f)
        {
        }
