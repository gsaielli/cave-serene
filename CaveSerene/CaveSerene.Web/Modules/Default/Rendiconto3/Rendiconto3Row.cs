...
namespace CaveSerene.Default.Entities
{
    ...
    public sealed class Rendiconto3Row : Row<Rendiconto3Row.RowFields>, IIdRow, INameRow
    {
        ...
        [DisplayName("Impianto"), Expression("jIdStruttura.[Nome]"), QuickSearch, NameProperty]
        ...
        public Rendiconto3Row(RowFields f)
            : base(f)
        {
        }
