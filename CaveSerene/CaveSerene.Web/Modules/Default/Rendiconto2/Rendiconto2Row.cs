...
namespace CaveSerene.Default.Entities
{
    ...
    public sealed class Rendiconto2Row : Row<Rendiconto2Row.RowFields>, IIdRow, INameRow
    {
        ...
        [DisplayName("Autorizzazione"), Column("Descrizione"), QuickSearch, NameProperty]
        ...
        public Rendiconto2Row(RowFields f)
            : base(f)
        {
        }
