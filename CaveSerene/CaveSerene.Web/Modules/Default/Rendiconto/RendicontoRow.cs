...
namespace CaveSerene.Default.Entities
{
    ...
    [DisplayName("Rendiconti delle Cave"), InstanceName("Rendiconto Cava")]
    [ReadPermission("Administration:General")]
    [ModifyPermission("Administration:General")]
    public sealed class RendicontoRow : Row<RendicontoRow.RowFields>, IIdRow, INameRow
    {
        ...
        [DisplayName("Autorizzazione"), Column("IDAutorizzazione"), ForeignKey("Autorizzazione", "ID"), LeftJoin("jIdAutorizzazione"), NotNull, TextualField("Descrizione")]
        [LookupEditor(typeof(AutorizzazioneLookup))]
        ...
        [DisplayName("Altro Descr."), Size(100), QuickSearch, NameProperty]
        ...
        [DisplayName("Diritto Prop"), Size(11), Scale(2)]
        ...
        public RendicontoRow()
            : base(Fields)
        {
        }

        public RendicontoRow(RowFields f)
            : base(f)
        {
        }
