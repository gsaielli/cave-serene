using CaveSerene.Administration.Entities;
...
using MyRow = CaveSerene.Administration.Entities.UserPermissionRow;

namespace CaveSerene.Administration.Repositories
{
